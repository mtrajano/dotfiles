...
nnoremap <silent> <buffer> <leader>D :!open -a Firefox https://www.dictionary.com/browse/<C-r>=expand('<cword>')<cr> &<cr>
nnoremap <silent> <buffer> <leader>T :!open -a Firefox https://www.thesaurus.com/browse/<C-r>=expand('<cword>')<cr> &<cr>
